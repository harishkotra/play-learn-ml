...
const modules = [
  ...
  },
  {
    ...
    icon: "⚖️",
    title: "Probability Seesaw",
    subtitle: "Logistic Regression",
    color: "border-workshop-accent",
    bg: "bg-workshop-accent/10",
    desc: "The S-curve (sigmoid) separates two classes. Adjust the model and watch probabilities balance like a seesaw.",
  },
  {
    path: "/pca",
    icon: "🎭",
    ...
    color: "border-workshop-accent2",
    bg: "bg-workshop-accent2/10",
    desc: "Drag to rotate a line and watch data points cast 'shadows.' The direction with the most spread is the first principal component.",
  },
  {
    path: "/svm",
    icon: "🤼",
    ...
    color: "border-workshop-accent3",
    bg: "bg-workshop-accent3/10",
    desc: "Support vectors are the outermost points holding the margin. Add and remove points to see the decision boundary shift.",
  },
  {
    path: "/naive-bayes",
    icon: "📧",
    ...
    color: "border-workshop-accent4",
    bg: "bg-workshop-accent4/10",
    desc: "Drag emails into Spam/Not Spam categories. Watch word probabilities update in real-time using Bayes' Theorem.",
  },
  {
    path: "/tsne",
    icon: "🦋",
    ...
    color: "border-workshop-accent",
    bg: "bg-workshop-accent/10",
    desc: "Watch high-dimensional data (6D) unfold into 2D. Adjust perplexity to see local vs global structure emerge.",
  },
];
