...
| **Gradient Descent** | "Roller Coaster" — a ball rolling down the loss landscape | Medium |
| **Confusion Matrix** | "Sorting Machine" — drag predictions into TP/TN/FP/FN bins | Easy |
| **Overfitting Simulator** | "The Emperor's Tailor" — a model that perfectly fits noise | Easy |
